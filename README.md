...
- high granularity: just a fancy way of saying that you can search for strings within a single note file too. (For example, if it's very long). The app lets you jump back and forth between occurrences of the queried string.
